...
const Linux = () => {
  return (
    <>
      ...
      <p>
        Virtualization involves installing an emulator to run an instance of the
        Linux os inside a window on a host computer. The main benifit of this
        type of install is the ability to add and remove various versions of
        OS's without the need of making any major change to your hard drive. It
        is the easiest to implement. The downsides include needing at least 8gb
        of ram for the set up we are running, as well as needing different
        install software depending on your native OS. In addition the computer
        vision software requirements are different, and running those algorithms
        might produce unexpected results, or refuse to run altogether. Still a
        great choice if Linus is new to you and want to try it out risk free.
      </p>
      ...
      <p>
        ...
        least computer requirements, as Linux is installed on the hard drive and
        uses all host resources. Partitioning is potentially risky as there is a
        possibility of deleting your operating system but as long as you are
        paying attention and following steps there should be no problems.
      </p>
