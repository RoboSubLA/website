    ...
    return (
        ...
        <div>
            ...
            <div className='links-container'>
                <a className='resource-links' href='https://www.arduino.cc/en/Guide/Windows'><i class="fab fa-windows"> Windows</i></a>
                <a className='resource-links' href='https://www.arduino.cc/en/Guide/MacOSX'><i class="fab fa-apple"> Mac OS</i></a>
                <a className='resource-links' href='https://www.arduino.cc/en/Guide/Linux'><i class="fab fa-linux"></i> Linux</a>   
            </div>
