      ...
      <Jumbotron className="git" fluid>
        <Container>
          ...
          <p className="resources-section-p">
            ...
            large web sites, or other collections of information. Version
            control is a component of software configuration management.
          </p>
          ...
          <CardDeck className="git-carddeck">
            <Card className="git-card" border="dark">
              <Card.Body className="git-card-body">
                <Card.Title className="git-card-title">SETUP</Card.Title>
            ...
            <Card className="git-card" border="dark">
              <Card.Body className="git-card-body">
                <Card.Title className="git-card-title">SETUP & INIT</Card.Title>
                <Card.Text className="git-card-text">
                  Configuring user information used across all local
                  repositories
                </Card.Text>
          ...
          <CardDeck className="git-carddeck">
            ...
            <Card className="git-card" border="dark">
              <Card.Body className="git-card-body">
                ...
                <p className="git-cheat-p">
                  List your branches. a * will appear next to the currently
                  active branch
                </p>
